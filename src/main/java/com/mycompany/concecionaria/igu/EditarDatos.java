...
public class EditarDatos extends javax.swing.JFrame {
    ...
    public EditarDatos(int id_auto) {
        initComponents();
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        Automovil IdAuto = control.traerAuto(auto.getId());
        
        IdAuto.setMarca(txt_marca.getText());
        IdAuto.setColor(txt_color.getText());
        IdAuto.setModelo(txt_modelo.getText());
        IdAuto.setMotor(txt_motor.getText());
        IdAuto.setPatente(txt_patente.getText());
        IdAuto.setCantPuertas(Integer.parseInt(txt_puertas.getText()));
        

        //pasamos el masco, para poder obtener la id
        control.editar(IdAuto);

        mostrarMensaje("Se guardo el registo", "Info", "Eliminado con exito");
    ...
    private void cargarDatos(int id_auto) {
        ...
        txt_puertas.setText(Integer.toString(auto.getCantPuertas()));
